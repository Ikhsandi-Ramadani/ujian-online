<template>
    <Head>
        <title>Kelompok Soal - Aplikasi Ujian Online</title>
    </Head>
            ...
            <div class="col-md-8">
                <div class="row">
                    <div class="col-md-3 col-12 mb-2">
                        <Link href="/teacher/question_groups/create" class="btn btn-md btn-primary border-0 shadow w-100"
            ...
            <div class="col-md-12">
                <div class="card border-0 shadow">
                    <div class="card-body">
                            ...
                            <table class="table table-bordered table-centered table-nowrap mb-0 rounded">
                                <thead class="thead-dark">
                                    <tr class="border-0">
                                        ...
                                        <th class="border-0">Nama Kelompok Soal</th>
                                ...
                                <div class="mt-2"></div>
                                <tbody>
                                    <tr v-for="(question_group, index) in question_groups.data" :key="index">
                                        <td class="fw-bold text-center">{{ ++index + (question_groups.current_page - 1) *
                                            question_groups.per_page }}</td>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <button @click.prevent="destroy(question_group.id)"
                        ...
                        <Pagination :links="question_groups.links" align="end" />
                    </div>
                </div>
            </div>
        </div>
...
export default {
    ...
    setup() {
        ...
        const handleSearch = () => {
            Inertia.get('/teacher/question_groups', {
            ...
            Swal.fire({
                ...
                .then((result) => {
                    if (result.isConfirmed) {
                        ...
                        Inertia.delete(`/teacher/question_groups/${id}`);

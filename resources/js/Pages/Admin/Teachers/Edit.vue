<template>
    ...
    <div class="container-fluid mb-5 mt-5">
        <div class="row">
            <div class="col-md-12">
                <Link href="/admin/teachers" class="btn btn-md btn-primary border-0 shadow mb-3" type="button"><i
                    class="fa fa-long-arrow-alt-left me-2"></i> Kembali</Link>
                <div class="card border-0 shadow">
                    <div class="card-body">
                        <h5><i class="fa fa-user"></i> Edit Dosen</h5>
                        <hr>
                        <form @submit.prevent="submit">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="mb-4">
                                        <label>nip</label>
                                        <input type="text" class="form-control" placeholder="Masukkan nip Dosen"
                                            v-model="form.nip">
...
export default {
    ...
    setup(props) {
        ...
        const submit = () => {
            ...
            //send data to server
            Inertia.put(`/admin/teachers/${props.teacher.id}`, {
                //data
                nip: form.nip,
                name: form.name,
                gender: form.gender,
